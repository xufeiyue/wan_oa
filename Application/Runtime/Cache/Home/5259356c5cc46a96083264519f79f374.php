...
<div class="formbody">
    ...
    <ul class="forminfo">
        ...
        <li><label>系统时间：</label><input type="text" name="add_time" id="add_time" class="dfinput" onclick="jeDate({dateCell:'#add_time',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})"/></li>
        <li><label>合同编号：</label><input type="text" name="compact_no" class="dfinput" id="compact_no"/></li>
        <li><label>合同日期：</label><input type="text" name="compact_time" class="dfinput" id="compact_time" onclick="jeDate({dateCell:'#compact_time',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})"/></li>
        <li><label>客户名称：</label><input type="text" name="client_name" class="dfinput" id="client_name"/></li>
        <li><label>客户联系人：</label><input type="text" name="client_truename" class="dfinput" id="client_truename"/></li>
        <li><label>产品类型：</label>
        ...
        <li><label>服务性质：</label>
            <div id="wrap">
            新客户：<input type="radio" name="client_type"  value="新客户"/>
            老客户：<input type="radio" name="client_type"  value="老客户"/>
            </div>
        </li>
